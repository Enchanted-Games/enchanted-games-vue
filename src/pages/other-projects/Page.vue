<template>
    ...
    <div class="main-container">
        <img class="page-header-image pixelated" loading="lazy" alt="Page Icon" src="/static/project_icons/other-projects.png" />
...
export default {
    ...
    data() {
        return {
            projectType: "other-project", // types of projects that will be displayed
            projectViewPath: "/other-projects/view?p=", // base URL for projects to be viewed
