...
export default {
    ...
    data() {
        return {
            projectType: "minecraft-java-resource-pack", // types of projects that will be displayed
            projectViewPath: "/minecraft-java-resource-packs/view?p=", // base URL for projects to be viewed
            pageTitle: "Minecraft Java Resource Packs",

            markdown: `# Minecraft Java Edition Resource Packs
All my Resource Packs for Minecraft Java Edition. (Windows, MacOS, Linux)`,
            currentProjects: [],
        };
    },
    computed: {
...
<style lang="scss">
:root {
    --main-background-image: url(@/assets/images/backgrounds/minecraft_java_resourceepacks.png);
}
img {
    margin: auto;
}
